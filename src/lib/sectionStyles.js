/**
 * Shared Tailwind groups (order: layout → spacing → typography → color → effects → states).
 * Import into sections for consistent, readable class strings.
 */

export const sectionPy = 'py-16 lg:py-24'
export const sectionPyLoose = 'py-20 lg:py-24'

export const containerGrid12 = 'grid grid-cols-1 lg:grid-cols-12'
export const gridGapLg = 'gap-10 lg:gap-16'
