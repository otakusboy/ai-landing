...
/** Navbar theme tokens — edit link and surface colors here. */
...
export function navbarVariant(isPastHero) {
  return isPastHero ? 'scrolled' : 'top'
}
