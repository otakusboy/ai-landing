  ...
  return (
    <>
      ...
      <section
        ...
        className="relative -mt-[68px] flex h-screen min-h-screen w-full flex-col bg-cover bg-center bg-no-repeat pt-[68px]"
      ...
      >
        <Container className="relative z-10 flex flex-1 flex-col justify-end pb-[100px]">
          <div className="mx-auto w-full max-w-[650px] text-center">
            ...
            <p className="mx-auto mt-3 max-w-prose text-base leading-relaxed text-white/90 sm:text-lg">
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
              <Button
                ...
                className={heroButtonStyles.primary}
              >
                {primaryAction.label}
              </Button>
              <Button
